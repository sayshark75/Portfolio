      ...
      <Text align={"center"}>
        <Flex w={{ base: "280px", sm: "320px", md: "440px", lg: "560px" }} gap={5} mt={6} direction={"column"} justifyContent={"center"}>
          ...
          <Image
            ...
            transition={"750ms"}
            borderRadius={"12"}
            src={`https://streak-stats.demolab.com?user=sayshark75&theme=transparent&hide_border=true&background=3a3a3a&currStreakLabel=006aff&currStreakNum=006aff&sideNums=006aff&dates=006aff&stroke=006aff&sideLabels=006aff&icon_color=006aff`}
          />
        </Flex>
      </Text>
    </>
